...
const (
	...
	MK_CMD_REQ_SEND = uint16(0x0003)
	MK_CMD_RSP_SEND = uint16(0x0004)

	MK_CMD_REQ_RECV = uint16(0x0005)
	MK_CMD_RSP_RECV = uint16(0x0006)

	MK_CMD_REQ_CLOSE = uint16(0x0007)
	MK_CMD_RSP_CLOSE = uint16(0x0008)

	MK_CMD_REQ_NEWAGENT = uint16(0x0009)
	MK_CMD_RSP_NEWAGENT = uint16(0x000a)
)
